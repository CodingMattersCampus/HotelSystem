    ...
    <div class="col-md-3">
        <div class="box box-primary">
            ...
            <div class="box-footer">
                ...
                <form id="productDetailForm" method="post" action="{{\route('store.inventory.products.detail.edit', compact('product'))}}">
                    @csrf
...
$(function() {
    var table = $('#product-transaction-table').DataTable({
        ...
        "columns": [
            ...
            { 'data': 'in', searchable: false, orderable:false },
            { 'data': 'out', searchable: false, orderable:false },
    ...
    $('.switch.checkbox').each(function(){
        $(this).on('change', function(event){
            ...
            obj = new Object();
            obj[name] = value;
            $.post("{{\route('store.inventory.products.boolean.edit', compact('product'))}}",
            ...
            // $.ajax({
            //     url: "{{\route('store.inventory.products.detail.edit', compact('product'))}}",
            //     method: 'POST',
            //     data: {
