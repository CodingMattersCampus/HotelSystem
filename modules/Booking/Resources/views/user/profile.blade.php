        ...
        <hr style="background-color:rgb(0,0,0);">
           ...
           <button style="width:100%; border-radius: 20px;padding:8px;" type="button" class="btn btn-primary " data-toggle="modal" data-target="#myModal">Change Password</button>
                    ...
                    <div class="modal-dialog" style="width:30%;border-radius:10px;  ">
                        ...
                        <form id="myform" action="{{ route('booking.user.password.change') }}" class="basic-grey" method="POST">
                            @method('PATCH')
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input style="border-radius:10px;" class="form-control" type="password" name="current_password" id="current_password"  />
                            </div>
                        
                            <div class="form-group">
                                <label for="new_password" id="passwordLabel">* Password:</label>
                                <input style="border-radius:10px;" class="form-control" type="password" name="new_password" id="new_password" minlength=1 required />
                            </div>
                            <div  class="form-group">
                                <label for="new_password_confirmation" id="passwordLabelConfirm">*
                                Password Confirmation:</label>
                                <input style="border-radius:10px;"  class="form-control" type="password" name="new_password_confirmation" id="new_password_confirmation" minlength=1 required />
