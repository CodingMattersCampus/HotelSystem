    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="border-radius:10px;">
            <div class="modal-body" >
                <form id="employee-form" method="POST" action="{{ route('office.employee.record.create') }}" style="width:100%; display:block; background:white;">
                    @csrf
                                ...
                                <div class="panel-body" style="padding: 20px 30px">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group {{ $errors->has('date_employed') ? 'has-error' : '' }}">
                                            ...
                                            <input  placeholder="Date" class="form-control" type="text" id="date_employed" name="date_employed" data-provide="datepicker" class="hasDatepicker" style=" border-radius:10px; border:1px solid rgb(217, 221, 227); padding:8px" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group {{ $errors->has('birthdate') ? 'has-error' : '' }}">
                                            ...
                                            <input  placeholder="Date" class="form-control" data-provide="datepicker" type="text" id="birthdate" name="birthdate"  style=" border-radius:10px; border:1px solid rgb(217, 221, 227); padding:8px" required>
